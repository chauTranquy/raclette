...
public function __construct(){
	...
	require_once '../library/Gapi/gapi.class.php';
		...
		$client = Zend_Gdata_ClientLogin :: getHttpClient ($email, $password,'analytics');
$token = $client-> getClientLoginToken ();;
		
		$this->analytics  = new gapi($email,$password, $token);

		$this->_report_id=62704231;
	...
	public function query($dimensions, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=30){
		...
		//$this->analytics->requestReportData(62704231,'week','visits','week');
		
		return $this->analytics->requestReportData(62704231,array('browser','browserVersion'),array('pageviews','visits'));
