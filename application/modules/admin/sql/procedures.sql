...
CREATE PROCEDURE `getParam`(IN `key_IN` varchar(255),IN `id_params_IN` bigint, IN `id_site_IN` bigint)
BEGIN

select * from cms_params where `key`=key_IN and id_site=id_site_IN;
