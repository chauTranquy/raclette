...
Ext.define('TextoCMS.components.cms.fields.ContentBrowser' ,{
	...
	initComponent:function(){
		...
		if(this.rootIDs.length==0)classInstance.ajaxRequest('/admin/getjsondata?format=json',{API:'Application_Model_ArboMapper',APICall:'getRoots'}, this.getRootsID.bind(this), false);
