Ext.define('TextoCMS.controller.cms.FormController',{ 
	...
	saveFormCB:function(response){
		...
		data.baliseTitle=response.result.baliseTitle;
  	...
  	addArboItems:function(btn){
    	...
    	if(btn.text=="Modifier"){
    		view.setTitle('Editer');
    			...
    			if(!this.getContentform().selectedRub.isRoot())view.down('form').loadRecord(this.getContentform().selectedRub);//this.getContentform().selectedRub.store.findRecord("id_rubrique",this.getContentform().selectedRub.data.id_rubrique));
