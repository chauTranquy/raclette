Ext
		.define(
				'TextoCMS.view.siteadmin.templatesAdminViews.GridTemplatesForm',
				{
					...
					tbar:[{iconCls:'saveBtn', text:'Sauvegarder', disabled:true},{text:'Copier', action:'copy',iconCls:'copy'}],
					initComponent : function() {

						this.title = (this.record.get('id_templateRef') == 0 ? 'Ajout d\'un gabarit'
					...
					var typeCombo = Ext.create('Ext.form.field.ComboBox', {
						...
						labelWidth : 150,
						labelStyle : 'text-align:right'}
						}, {xtype:'gridtemplatesfields', templateRef:this.record.get('templateRef'), border:true, layout:'fit'}	];
