Ext.define('TextoCMS.view.medias.BrowserToolBar',{
	...
	var modifyFileBtn=Ext.create('Ext.button.Button',{tooltip:'Modifier l\'image', iconCls:'modifyFile', text:'Modifier', disabled:true, hidden:true});

	var items2=[ uploadFileBtn,deleteFileBtn,modifyFileBtn];
