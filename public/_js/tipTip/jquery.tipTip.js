    ...
    $.fn.tipTip = function (options) {
        ...
        return this.each(function () {
            ...
            function position_tiptip() {
                ...
                tiptip_holder
                    .css({ left: Math.round(tip_left), top: Math.round(tip_top),paddingTop:5 })
                ...
                if (tip_class == tip_classes.top) {
                    arrow_top = tip_height-4; // Position the arrow vertically on the top of the tooltip.
                    ...
                    arrow_top = 0-4; // Position the arrow vertically on the bottom of the tooltip.
                    arrow_left = org_left - tip_left + ((org_width - arrow_width) / 2); // Center the arrow horizontally on the center of the target element.
