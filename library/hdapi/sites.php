...
echo "</p><h1>All Detection Information</h1><p>";
...
// If your site has access to download our device specs database only.
echo "</p><h1>All Handset Information</h1><p>";
...
// If your account has access to download our device database & detection rules
// then this is how you do it.
echo "</p><h1>All Handset and Detection Information</h1><p>";
if ($hd3->siteFetchAll()) {
	$data = $hd3->getRawReply();
	echo "Downloaded ".strlen($data)." bytes";
} else {
